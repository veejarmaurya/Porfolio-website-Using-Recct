    ...
    return(
        <>
           <div id="skills" className="w-full h-auto bg-lime-200">
                ...
                <div className="flex md:flex-row justify-evenly mt-10">
                    <div className=" border-4 w-64 h-64 rounded-3xl shadow-2xl shadow-black bg-lime-200 hover:-translate-y-1 hover:scale-110 hover:bg-gradient-to-r from-yellow-300 to-green-300">
                        ...
                        <div className="border-4 w-64 h-64 items-center rounded-3xl shadow-2xl shadow-black bg-lime-200 hover:-translate-y-1 hover:scale-110 hover:bg-gradient-to-r from-yellow-300 to-blue-300">
                        ...
                        <div className="border-4 w-64 h-64 items-center rounded-3xl shadow-2xl shadow-black bg-lime-200 hover:-translate-y-1 hover:scale-110 hover:bg-gradient-to-r from-yellow-300 to-green-300">
