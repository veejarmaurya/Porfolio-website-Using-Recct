...
const banner =()=>{
    ...
    return(
        <>
           <div className=" flex-col md:flex-row md:flex md:items-center "> 
               ...
               <div className="md:w-full md:h-full flex justify-center relative inset-0 bg-gradient-to-r from-yellow-500 to-green-500 m-0 p-0">
  ...
  <path fill="#FF0066" d="M41.6,-63.9C54.6,-56.4,66.2,-46,74.7,-32.6C83.2,-19.2,88.5,-2.9,84.7,11C80.9,24.9,67.9,36.2,56.6,48.7C45.2,61.1,35.6,74.6,22.9,78.7C10.2,82.7,-5.5,77.3,-18.4,70.2C-31.4,63,-41.8,54.1,-50.6,43.8C-59.4,33.6,-66.7,22.1,-70.8,8.8C-75,-4.6,-75.8,-19.8,-69.5,-30.9C-63.1,-42,-49.5,-48.9,-36.7,-56.5C-23.9,-64.1,-12,-72.4,1.2,-74.2C14.3,-76,28.6,-71.4,41.6,-63.9Z" transform="translate(100 100)" />
                     ...
                     <div  className="w-2/3 z-10 md:h-[400px]">
               ...
               {/* image area */}
               <div className="  invisible  md:visible h-0 md:h-full md:w-full  md:flex  md:justify-center md:bg-gradient-to-r from-green-500 to-yellow-500 m-0 p-0">
